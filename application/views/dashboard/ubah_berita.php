<div id="page-wrapper">
        ...
        <div class="form-group">
            <h5>Judul Berita</h5>
            <input type="text" name="jb" class="form-control" value="<?= $berita['jdl_berita'] ?>">
        </div>
        <div class="form-group">
            <h5>Tanggal Berita</h5>
            <input type="date" name="tgl" class="form-control" value="<?= $berita['tgl_berita'] ?>">
        </div>
        <div class="form-group">
            <h5>Isi Berita</h5>
            <textarea name="isi" id="editor"><?= $berita['isi_berita'] ?></textarea>
        </div>
        <div class="form-group">
            <h5>Gambar</h5>
